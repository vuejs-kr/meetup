      ...
      <div class="wrapper">
        <nav>
          ...
          <ul>
            ...
            <li><a href="https://onoffmix.com/event/109807" class="enter-button" target="_blank">참가 신청</a></li>
          </ul>
        </nav>
      </div>
    </div>
...
export default class AppHeader extends Vue {
  ...
  private scrollEvent() {
    if (window.innerHeight < window.scrollY) {
      (this.$refs.header as HTMLDivElement).className = 'app-header fixed';
    } else {
      (this.$refs.header as HTMLDivElement).className = 'app-header';
    }
  }
}
</script>
