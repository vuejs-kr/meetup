  ...
  <el-row>
    <el-container id="gotcha" class="gotcha" direction="vertical" :style="{ height: `${innerHeight}px` }">
      ...
      <div class="center" :class="{ laptop, desktop }">
        <img src="~@/assets/fourth/logo.png" alt="뷰티풀 코리아" class="logo" :class="{ laptop, desktop }">
...
.el-carousel__item:nth-child(3) {
  background: url(~@/assets/fourth/img/gotcha/meetup01.png) no-repeat center center;
...
.el-carousel__item:nth-child(4) {
  background: url(~@/assets/fourth/img/gotcha/meetup02.png) no-repeat center center;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
  background-size: cover;
...
.el-carousel__item:nth-child(5) {
  background: url(~@/assets/fourth/img/gotcha/meetup03.png) no-repeat center center;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
  background-size: cover;
...
.bg-dot {
  position: absolute;
  background: url(~@/assets/fourth/img/gridtile.png);
